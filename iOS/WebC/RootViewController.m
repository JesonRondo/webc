...
- (void)viewDidLoad {
    ...
    // 设置navigation
    [WebCAppManage shareInstance].navigation = self.navigationController;
...
- (void)openLiteApp {
    [[WebCAppManage shareInstance] launchAppKeyName:@"douban"
                                         withBundle:@"http://172.17.37.51:8080/app.bundle.js"];
}
